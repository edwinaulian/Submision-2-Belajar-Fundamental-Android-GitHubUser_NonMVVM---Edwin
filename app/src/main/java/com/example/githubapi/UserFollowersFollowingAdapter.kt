    ...
    inner class UserViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        fun bind(getResponse: ListFollowersResponseItem) {
            with(itemView) {
                ...
                val tvText_Login : TextView = findViewById(R.id.tvUserNameListFollowers)
                val tvText_Type  : TextView = findViewById(R.id.tvTypeListFollowers)
                val tvImg        : ImageView = itemView.findViewById(R.id.img_item_avatar_detail_activity_followers)
